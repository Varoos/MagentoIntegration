...
function ItemCallback(response) {
    ...
    //Focus8WAPI.getFieldValue("ItemDataCallback", ["sName", "sCode", "IntegrationFlag"], 1, false, 111);
    Focus8WAPI.getFieldValue("ItemDataCallback", ["sName", "sCode"], 1, false, 111);
}
...
function ItemDataCallback(response1) {
    ...
    //intgflag = response1.data[2].FieldValue;
